        ...
        <div className="col-md-12">
          <div className='panel panel-default'>
            <div className='panel-body'>
              <span className="submit_deployment_heading">I will be deploying </span> <span className="submit_deployment_answer">{this.props.appName ? this.props.appName  :"_________"} </span>
